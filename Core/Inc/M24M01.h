...
//#ifndef _M24M01_H
//#define _M24M01_H
#ifndef INC_M24M01_H_
#define INC_M24M01_H_

#include "stm32f4xx_hal.h"

#define EEPROM_EnableWriteControl()     HAL_GPIO_WritePin(GPIOB, GPIO_PIN_6, GPIO_PIN_SET); //set WC# to high
#define EEPROM_DisableWriteControl()    HAL_GPIO_WritePin(GPIOB, GPIO_PIN_6, GPIO_PIN_RESET); //set WC# to low
